...
func initialize_stats() -> bool:
	...
	GLOBAL.STATS.add_stat(stat)
	stat = Stat.new(GLOBAL.STAT_TYPE.ENERGY_CONVERTER, 9, 50000, 50000, 100, Big.new(2.5, 6), 7, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(2.43,5), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.ADDITION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	stat = Stat.new(GLOBAL.STAT_TYPE.ENERGY_CONVERTER, 10, 100000, 100000, 100, Big.new(1.25,7), 7, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(7.29,5), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.ADDITION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	stat = Stat.new(GLOBAL.STAT_TYPE.ENERGY_CONVERTER, 11, 1000000, 1000000, 100, Big.new(6.25, 7), 7, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(2.187,6), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.ADDITION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	...
	stat = Stat.new(GLOBAL.STAT_TYPE.TESSARACT_ENERGY_MATRIX, 1, 2, 1, 3, Big.new(5,6), 1000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(2,7), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	# Echo of the Collapsing Core (EPS multiplier)
	stat = Stat.new(GLOBAL.STAT_TYPE.ECHO_OF_THE_COLLAPSING_CORE, 2, 2, 1, 5, Big.new(5,8), 5000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(4,9), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	# Fragment of the First Spark (EPS multiplier)
	stat = Stat.new(GLOBAL.STAT_TYPE.FRAGMENT_OF_THE_FIRST_SPARK, 3, 2, 1, 10, Big.new(1.5,11), 10000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(4.28,12), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_SECOND, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	# Omnicore Collection Engine (EPC multiplier)
	stat = Stat.new(GLOBAL.STAT_TYPE.OMNICORE_COLLECTION_ENGINE, 1, 2, 1, 3, Big.new(5,6), 1000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(2,7), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_CELL, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	# Singularity Intake (EPC multiplier)
	stat = Stat.new(GLOBAL.STAT_TYPE.SINGULARITY_INTAKE, 2, 2, 1, 5, Big.new(5,8), 5000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(4,9), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_CELL, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
	# Pulse of the Universe (EPC multiplier)
	stat = Stat.new(GLOBAL.STAT_TYPE.PULSE_OF_THE_UNIVERSE, 3, 2, 1, 10, Big.new(1.5,11), 10000, GLOBAL.UNLOCK_METRIC.TOTAL_TPS, Big.new(4.28,12), GLOBAL.VALUE_APPLIED_TO.ENERGY_PER_CELL, GLOBAL.VALUE_APPLICATION_TYPE.MULTIPLICATION, GLOBAL.VALUE_TYPE.NUMBER)
	GLOBAL.STATS.add_stat(stat)
